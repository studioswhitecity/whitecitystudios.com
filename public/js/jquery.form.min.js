!function (e) {
    ...
    e.fn.attr2 = function () {
        ...
        var n, o, s, u = this;
        "function" == typeof a && (a = {success: a}), n = this.attr2("method"), (s = (s = "string" == typeof (o = this.attr2("action")) ? e.trim(o) : "") || window.location.href || "") && (s = (s.match(/^([^#]+)/) || [])[1]), a = e.extend(!0, {
            url: s,
        ...
        var f, m = [], d = this.formToArray(a.semantic, m);
        ...
        var g = e('input[type=file]:enabled[value!=""]', this).length > 0, x = "multipart/form-data",
            b = u.attr("enctype") == x || u.attr("encoding") == x, y = t.fileapi && t.formdata;
        i("fileAPI :" + y);
        var T, j = (g || b) && !y;
        !1 !== a.iframe && (a.iframe || j) ? a.closeKeepAlive ? e.get(a.closeKeepAlive, function () {
            ...
            a.uploadProgress && (s.xhr = function () {
                ...
                return e.upload && e.upload.addEventListener("progress", function (e) {
                    var t = 0, r = e.loaded || e.position, n = e.total;
        ...
        function S(t) {
            var o, s, l, c, f, d, p, h, v, g, x, b, y = u[0], T = e.Deferred();
            if (t) for (s = 0; s < m.length; s++) o = e(m[s]), r ? o.prop("disabled", !1) : o.removeAttr("disabled");
            ...
            var k = e("meta[name=csrf-token]").attr("content"), D = e("meta[name=csrf-param]").attr("content");

            function A() {
                var t = u.attr2("target"), r = u.attr2("action");
                ...
                var a = [];
                try {
                    if (l.extraData) for (var o in l.extraData) l.extraData.hasOwnProperty(o) && (e.isPlainObject(l.extraData[o]) && l.extraData[o].hasOwnProperty("name") && l.extraData[o].hasOwnProperty("value") ? a.push(e('<input type="hidden" name="' + l.extraData[o].name + '">').val(l.extraData[o].value).appendTo(y)[0]) : a.push(e('<input type="hidden" name="' + o + '">').val(l.extraData[o]).appendTo(y)[0]));
                ...
                if (!h.aborted && !M) {
                    ...
                    if (L && L.location.href != l.iframeSrc || x) {
                        ...
                        try {
                            ...
                            var s = (l.dataType || "").toLowerCase(), u = /(json|script|text)/.test(s);
                            if (u || l.textarea) {
                                ...
                                if (f) h.responseText = f.value, h.status = Number(f.getAttribute("status")) || h.status, h.statusText = f.getAttribute("statusText") || h.statusText; else if (u) {
                                    var m = L.getElementsByTagName("pre")[0], v = L.getElementsByTagName("body")[0];
        ...
        var i, o, s, u, l, c, f, m = this[0], d = r ? m.getElementsByTagName("*") : m.elements;
        if (!d) return n;
        for (i = 0, c = d.length; i < c; i++) if ((s = (l = d[i]).name) && !l.disabled) if (r && m.clk && "image" == l.type) m.clk == l && (n.push({
            name: s,
            value: e(l).val(),
            type: l.type
        }), n.push({name: s + ".x", value: m.clk_x}, {
            name: s + ".y",
            value: m.clk_y
        })); else if ((u = e.fieldValue(l, !0)) && u.constructor == Array) for (a && a.push(l), o = 0, f = u.length; o < f; o++) n.push({
            name: s,
            value: u[o]
        ...
        if (!r && m.clk) {
            ...
            (s = v.name) && !v.disabled && "image" == v.type && (n.push({
                name: s,
                value: h.val()
            }), n.push({name: s + ".x", value: m.clk_x}, {name: s + ".y", value: m.clk_y}))
        }
        return n
